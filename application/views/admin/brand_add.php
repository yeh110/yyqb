            ...
            <div id="content-wrap" class="content-wrap">
            	<div class="major-main">
                    	...
                    	<ul class="ui-tab-navigator">
                            ...
                            <li class="active"><a href="<?=admin_site('brand/add')?>">品牌添加</a></li>
                      	</ul>
                        	...
                        	<dl class="detail-part">
                            	<dd class="form-row">
                                    ...
                                    <div class="form-value">
                                    	<input type="text" class="form-control" name="cnname" style="width:400px">
                                    </div>
                                </dd>
                                <dd class="form-row">
                                    <label>英文名称：</label>
                                    <div class="form-value">
                                        <input type="text" class="form-control" name="enname" style="width:400px">
                                    </div>
                                </dd>
                                <dd class="form-row">
                                    <label>品牌图片：</label>
                                    <div class="form-value">
                                        <input type="text" class="form-control fl" name="logofile" style="width:330px;margin-right:10px;" readonly><button class="btn btn-default fl" type="button" name="uploadbtn">上传</button> 
                                    </div>
                                </dd>
                                <dd class="form-row">
                                    <label>排序：</label>
...
$(function () {
    ...
    $('#myform').submit(function(){
        if($('input[name="cnname"]').val()==''){
            ...
            yh_ajax_post('<?=admin_site('brand/addAjax')?>', $(this).serialize(), function(data){
                if(data.errNum===0){
