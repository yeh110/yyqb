            ...
            <div id="content-wrap" class="content-wrap">
            	<div class="major-main">
                    	...
                    	<ul class="ui-tab-navigator">
                            ...
                            <li class="active"><a href="<?=admin_site('article/edit')?>?id=<?=$field['id']?>">内容修改</a></li>
                      	</ul>
                        	...
                        	<dl class="detail-part">
                            	<dd class="form-row">
                                    ...
                                    <div class="form-value">
                                    	<input type="text" class="form-control" name="title" value="<?=$field['title']?>" style="width:400px">
                                    </div>
                                </dd>
                                <dd class="form-row">
                                    <label>视频地址：</label>
                                    <div class="form-value">
                                        <input type="text" class="form-control" name="videourl" value="<?=$field['videourl']?>" style="width:400px">
                                    </div>
                                </dd>
                                <dd class="form-row">
                                    <label>视频图片：</label>
                                    <div class="form-value">
                                        <input type="text" class="form-control fl" name="litpic" value="<?=$field['litpic']?>" style="width:330px;margin-right:10px;" readonly><button class="btn btn-default fl" type="button" name="uploadbtn">上传</button> 
                                    </div>
                                </dd>
                                <dd class="form-row">
                                    <label>所属栏目：</label>
                                    <div class="form-value">
                                        <select class="form-control" name="tid" style="width:400px">
                                            ...
                                            <?php foreach ($arctype as $r):?>
                                             <option value="<?=$r['tid']?>"<?=$field['bid']==$r['tid'] ? ' selected' : NULL?>><?=$r['typename']?></option>
                                    ...
                                    <div class="form-value">
                                        <select class="form-control" name="bid" style="width:400px">
                                            ...
                                            <?php foreach ($brand as $r):?>
                                             <option value="<?=$r['id']?>"<?=$field['bid']==$r['id'] ? ' selected' : NULL?>><?=$r['cnname']?></option>
...
$(function () {
    ...
    $('#myform').submit(function(){
        if($('input[name="title"]').val()==''){
            ...
            yh_ajax_post('<?=admin_site('article/editAjax')?>', $(this).serialize(), function(data){
                if(data.errNum===0){
